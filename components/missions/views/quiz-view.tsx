...
export function QuizView({
  ...
  return (
    <div className="flex flex-col justify-stretch w-full max-w-7xl mx-auto px-4 py-2 gap-4">
      <div className="flex flex-col lg:flex-row gap-8 w-full">
        ...
        <div className="flex flex-col items-center justify-center gap-3">
          <MascotCallout
            ...
            className="[&>div:last-child]:!w-[180px] [&>div:last-child]:!h-[320px] [&_img]:!object-cover [&_img]:!object-top"
          />
        </div>
      </div>
