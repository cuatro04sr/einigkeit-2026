  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full mx-auto px-4 py-2">
        ...
        <Card className="w-full bg-[#FFFDF9] border-slate-200/80 rounded-2xl shadow-none mt-4 py-0">
          <CardContent className="flex items-center justify-between p-3 sm:p-4 gap-2">
            ...
            {!isSurveyPhase && (
              <div className="flex items-center gap-2 bg-white px-3 sm:px-4 py-2 rounded-xl border border-red-100 shadow-sm shrink-0">
                <Clock className="w-4 h-4 text-red-600 animate-pulse" />
                <span className="text-sm sm:text-base font-extrabold text-red-600 font-mono">
                  {formatTime(timeLeft)}
                </span>
              </div>
            )}
            ...
            {isSurveyPhase && (
              <Button
                ...
                size="lg"
                className="rounded-xl font-medium px-4 sm:px-6 bg-red-600 hover:bg-red-700 text-white shadow-none text-sm shrink-0"
              >
