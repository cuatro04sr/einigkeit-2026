  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 md:px-6 lg:px-12 flex flex-col gap-2 lg:gap-4">
        <header className="w-full lg:w-1/2 max-w-2xl lg:max-w-none flex flex-col items-start gap-2 text-left">
          ...
          <div className="text-md font-medium leading-tight space-y-1">
